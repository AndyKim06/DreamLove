...
EXPLICIT_LOCATION_KEYWORDS = [
    "영화관", "미술관", "한강", "공원", "바다", "공연장", "와인바",
    "놀이공원", "레스토랑", "도서관", "쇼핑몰", "백화점", "전시장",
    "버스정류장", "지하철역", "기차역", "길거리", "거리", "카페",
    "학교", "회사", "집앞", "동네", "술집", "맛집", "식당", "서점",
    "공항", "지하철", "버스", "택시", "집"
]
# 길이 순으로 정렬 (긴 단어부터 매칭하여 '맛집'이 '집'으로 매칭되는 것 방지)
EXPLICIT_LOCATION_KEYWORDS.sort(key=len, reverse=True)
